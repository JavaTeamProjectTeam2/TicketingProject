...
public class PerformRepository {
    ...
    static {
        performMap.put("SHINee WORLD Ⅵ [PERFECT ILLUMINATION : SHINee’S BACK", new Perform("SHINee WORLD Ⅵ [PERFECT ILLUMINATION : SHINee’S BACK", CONCERT, "인스파이어 아레나", SEVEN.getAge(), new PerformDate()));
